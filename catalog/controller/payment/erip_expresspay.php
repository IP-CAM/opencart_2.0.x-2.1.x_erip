...
class ControllerPaymentEripExpressPay extends Controller {
	...
	public function success() {
		...
		$this->response->setOutput($this->load->view('default/template/payment/erip_expresspay_success.tpl', $data));
	}
	...
	public function fail() {
		...
		$this->response->setOutput($this->load->view('default/template/payment/erip_expresspay_failure.tpl', $data));
	}
